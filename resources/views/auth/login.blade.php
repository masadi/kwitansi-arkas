...
@section('content')
<?php
$tahun_anggaran = \App\Models\Tahun_anggaran::get();
?>
    ...
    <div class="auth-inner my-2">
      ...
      <div class="card mb-0">
        <div class="card-body">
          ...
          <p class="card-text mb-2">Silahkan login untuk memulai berpetualang!</p>
          ...
          <form class="auth-login-form mt-2" method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-1">
              ...
              <select name="tahun_anggaran_id" id="tahun_anggaran_id" class="form-control form-control-merge">
                @foreach($tahun_anggaran as $tahun)
                <option value="{{$tahun->tahun_anggaran_id}}" {{($tahun->periode_aktif) ? 'selected' : ''}}>{{$tahun->nama}}</option>
                @endforeach
              </select>
            </div>
            <div class="mb-1">
